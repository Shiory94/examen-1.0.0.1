...
public class DashboardController {
	...
	@RequestMapping(value = "home/enterprices", method = RequestMethod.GET)
	public String showEnterprices(Model model, HttpServletRequest request) {

		List<Enterprice> lista = peruInkaService.findAllEnterprice();

		model.addAttribute("empresas", lista);
		request.getSession().setAttribute("menuHeader", "enterprices");

		return "home/enterprices";
	}
	...
	public String saveHotel(Model model, @ModelAttribute("customer") Customer customer, HttpServletRequest request) {
		String opc = request.getParameter("opc");
	...
	@RequestMapping(value = "home/tickets", method = RequestMethod.GET)
	public String showTickets(Model model, HttpServletRequest request) {

		List<Ticket> lista = peruInkaService.findAllTicket();

		model.addAttribute("boletos", lista);
		request.getSession().setAttribute("menuHeader", "tickets");

		return "home/tickets";
	}

	@RequestMapping(value = "home/frmTicket", method = RequestMethod.GET)
	public String getFrmTicket(Model model) {

		model.addAttribute("ticket", new Ticket());
		model.addAttribute("clientes", peruInkaService.findAllCustomer());
		model.addAttribute("opc", "new");
		return "home/frmTicket";
	}

	@RequestMapping(value = "home/saveTicket", method = RequestMethod.POST)
	public String saveTicket(Model model, @ModelAttribute("ticket") Ticket ticket, HttpServletRequest request) {
	...
	public String deleteTicket(@RequestParam("id_") Long id) {
	...
	public String getEditTicket(Model model, @RequestParam("id_") Long id) {

		Ticket ticket = peruInkaService.searchTicket(id);
