			...
			<div class="nav-collapse">
				<nav class="nav">
					<ul class="nav">
						...
						<li <c:if test="${menuHeader eq 'enterprices'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/enterprices">Empresas</a></li>
						<li <c:if test="${menuHeader eq 'customers'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/customers">Clientes</a></li>
						<li <c:if test="${menuHeader eq 'tickets'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/tickets">Boletos</a></li>
